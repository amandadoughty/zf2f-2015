...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        $shared->attach(NotificationEvent::NOTIFICATION_EVENT_IDENTIFIER,
                        NotificationEvent::NOTIFICATION_EVENT_NOTIFY,
    ...
    public function getServiceConfig()
    {
        return [
            'services' => [
                ...
                'notification-notice' => '<script>alert("Message Sent");</script>',
            ],
            'factories' => [
	 ...
	 */
	 public function sendNotification($e) 
	 {
        ...
        // add notification "notice" to layout
        $viewModel = $sm->get('Application')->getMvcEvent()->getViewModel();
        $viewModel->setVariable('notification', $sm->get('notification-notice'));
	}
